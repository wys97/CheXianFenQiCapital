  ...
  <div class="container" v-if="detailData.repaymentPreviewDto">
    <div class="top">
      <ul class="flex-item">
      	...
      	<li>最近一次还款时间：{{detailData.backDate}}</li>
      </ul>
		            ...
		            <div class="core-enterprise info-list">
		              	<div class="table_top">
		              		...
		              		<el-row>
			              			...
			              			<el-col :span="20" class="bg_right">{{detailData.repaymentPreviewDto.supplierName?detailData.repaymentPreviewDto.supplierName:'--'}}</el-col>
			              	</el-row>
			              	<el-row >
			              	...
			              	<el-row >
			              			...
			              			<el-col :span="20" class="bg_right">{{detailData.repaymentPreviewDto.loanTime?detailData.repaymentPreviewDto.loanTime:'--'}}</el-col>
			              	</el-row>
			              	<el-row >
			              			<el-col :span="4" class="grid-content bg_left">当前期数</el-col>
			              			<el-col :span="8" class="bg_right">{{detailData.repaymentPreviewDto.periods!==''?detailData.repaymentPreviewDto.periods:'--'}} 期</el-col>
			              			<el-col :span="4" class="grid-content bg_left">总期数</el-col>
			              			<el-col :span="8" class="bg_right">{{detailData.repaymentPreviewDto.totalPeriods?detailData.repaymentPreviewDto.totalPeriods:'--'}} 期</el-col>
			              	</el-row>
			              	<el-row>
			              			<el-col :span="4" class="grid-content bg_left">计划还款金额</el-col>
			              			<el-col :span="8" class="bg_right">{{detailData.repaymentPreviewDto.backPlanAmt?detailData.repaymentPreviewDto.backPlanAmt:'--'}} 元</el-col>
			              			<el-col :span="4" class="grid-content bg_left">计划还款日期</el-col>
			              			<el-col :span="8" class="bg_right">{{detailData.repaymentPreviewDto.backPlanDate?detailData.repaymentPreviewDto.backPlanDate:'--'}}</el-col>
			              	</el-row>
			              	<el-row >
...
<script>
  ...
  export default {
    ...
    created () {
      	this.backPlanNo = this.$route.params.id
      	if (this.backPlanNo) {
        	this.init()
      	}
    },
    ...
    methods: {
    	fetchdata(){
      	...
      	getRepaymentDetail () {
	        repaymentDetail.repaymentDetail(this.backPlanNo).then(res => {
