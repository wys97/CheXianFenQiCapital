            ...
            <div class="tab-content">
              <p class="title">银行转账流水:</p>
                ...
                <div class="info-list">
                  ...
                  <template>
		                      ...
		                      <el-input :disabled="(!isAdd)&&((status !== 'AUDIT_REFUSE'))" v-model="formBankserial.bankAmt"></el-input>
		                    	...
		                    	<Upload :disabled="(!isAdd)&&((status !== 'AUDIT_REFUSE'))"
                ...
                <div class="info-list" style="text-align: right;" v-if="!roleHasPermissions['payment_manage_payment_income_saveSubmit']">
                  <el-button  @click="resetBankserial" :disabled="(!isAdd)&&(status !== 'AUDIT_WAIT')">重置</el-button>
                  <el-button  @click="saveBankserial" type="primary" :disabled="(!isAdd)&&(status !== 'AUDIT_WAIT')">保存并提交审核</el-button>
                </div>
              </el-form>
            </div>
          </el-tab-pane>
