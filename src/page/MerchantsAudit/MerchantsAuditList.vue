<template>
  <div class="page-container" ref="page-container" id="page-container"><!---商户审核管理--->
    ...
    <el-table :data="list" @current-change="handleSelectionChange" highlight-current-row :max-height=tableMaxHeight>
		...
		<el-table-column  prop="finalGrade" label="评级" width="130" align="center">
			<template slot-scope="scope" v-if="scope.row.finalGrade">
	          <div :class="scope.row.finalGrade==='A'?'suc':scope.row.finalGrade==='D'?'fail':'waring'">
