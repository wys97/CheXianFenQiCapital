        ...
        <ul>
          ...
          <li>
            <div class="fk_btn_box">
              <a :href="'/capital-api/creditline_report_zl/export?supplierCapitalId='+supplierCapitalId" target="_blank">
...
<script>
  ...
  import creditDetail from '@/api/merchantAuditManage/chinaTravelBankDetail'
