  ...
  <div class="container">
          ...
          <el-tab-pane class="tab_content" label="融资详情" name="first">
            <div class="tab-content">
              <div class="core-enterprise info-list">
              	...
              	<div class="table_top account_table">
	              	...
	              	<div v-for="(item,index) in financeDetailReceivables">
		              	<el-row  class="account_table_thead">
		              			...
		              			<el-col :span="5" class="account_td">{{item.returnDate?item.returnDate:'--'}}</el-col>
                ...
                <el-row>
								  	<el-col :span="24">
								  		<div class="grid-content bg-purple-dark">协议</div>
								  	</el-col>
								  	<el-col :span="24">
								  		<div>
								  			协议详情：
        	...
        	<el-tab-pane v-if="riskResult.bankRlt!=='HIDDEN'" label="银行流水信息" name="second">
						<div class="tab-content">
									...
									<template v-for="(item, index) in viewBankserial.bankSerial">
										<el-row>
											...
											<el-col :span="4" style="text-align: center;">
												<Upload  v-model="item.bankSerialKey" 
													:fileUrl="item.bankSerialUrl" 
													:dataObj="uploadImgData" 
													actionUrl="/capital-api/finance/upload_bankserial"></Upload>
    ...
    <el-dialog
      ...
      <div class="dialog-content">
        ...
        <div style="line-height: 40px;">银行流水匹配</div>
        <template>
        	<el-table
