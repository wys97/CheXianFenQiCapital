  ...
  <div class="container">
    ...
    <div class="top">
      <ul class="flex-item">
        ...
        <li>融资：{{headInfoData.amount}} 元  |  {{headInfoData.loanMonths}} 期<!--<el-button @click="method1(true)">前进</el-button><el-button @click="method1(false)">后退</el-button>--></li>
    ...
    <div class="content">
      <div class="flex-item">
        <el-tabs v-model="activeName2" type="card" @tab-click="handleClick">
              ...
              <div class="core-enterprise info-list">
              	...
              	<div class="table_top">
              		<el-row >
	              			...
	              			<el-col :span="20" class="bg_right">{{financeDetail.financeNo?financeDetail.financeNo:'--'}}</el-col>
	              	</el-row >
	              	<el-row >
	              			<el-col :span="4" class="grid-content bg_left">商户</el-col>
	              			<el-col :span="20" class="bg_right">{{financeDetail.supplierName?financeDetail.supplierName:'--'}}</el-col>
	              	</el-row>
	              	<el-row >
	              			<el-col :span="4" class="grid-content bg_left">融资方式</el-col>
	              			<el-col :span="20" class="bg_right">{{financeDetail.financeMethodText?financeDetail.financeMethodText:'--'}}</el-col>
	              	</el-row>
              		<el-row >
	              			<el-col :span="4" class="grid-content bg_left">融资金额</el-col>
	              			<el-col :span="8" class="bg_right">{{financeDetail.financeAmt?financeDetail.financeAmt:'--'}}</el-col>
	              			<el-col :span="4" class="grid-content bg_left">融资期限</el-col>
	              			<el-col :span="8" class="bg_right">{{financeDetail.financeMonths?financeDetail.financeMonths:'--'}}</el-col>
	              	</el-row >
	              	<el-row>
	              	...
	              	<el-row>
	              			<el-col :span="4" class="grid-content bg_left">年利率 </el-col>
	              	...
	              	<el-row >
	              			<el-col :span="4" class="grid-content bg_left">放款资方</el-col>
	              			<el-col :span="8" class="bg_right">{{financeDetail.capitalName?financeDetail.capitalName:'--'}}</el-col>
	              			<el-col :span="4" class="grid-content bg_left">签约方式</el-col>
	              			<el-col :span="8" class="bg_right">{{financeDetail.signTypeText?financeDetail.signTypeText:'--'}}</el-col>
	              	</el-row>
	              	<el-row >
	              ...
	              <div class="table_top_title">还款计划</div>
              	<div class="table_top account_table">
              		<el-row  class="account_table_tbody">
	              			<el-col :span="2" class="account_th">期数</el-col>
	              			<el-col :span="6" class="account_th">计划还款日期</el-col>
	              			<el-col :span="6" class="account_th">计划还款本金</el-col>
	              			<el-col :span="5" class="account_th">计划还款利息</el-col>
	              			<el-col :span="5" class="account_th">计划还款总金额</el-col>
	              	</el-row >
	              	<div v-for="(item,index) in backPlanList">
		              	<el-row  class="account_table_thead">
		              			<el-col :span="2" class="account_td">{{index+1}}</el-col>
		              			<el-col :span="6" class="account_td">{{item.planDate?item.planDate:'--'}}</el-col>
		              			<el-col :span="6" class="account_td">{{item.amount?item.amount:'--'}}</el-col>
		              			<el-col :span="5" class="account_td">{{item.interest?item.interest:'--'}}</el-col>
		              			<el-col :span="5" class="account_td">{{item.totalAmount?item.totalAmount:'--'}}</el-col>
		              	</el-row>
	              	</div>
	              </div>
	              <div v-if="financeDetail.financeMethod === 'ORDER'">
	              	<div class="table_top_title">转让的应收账款</div>
	              	<div class="table_top account_table">
	              		<el-row  class="account_table_tbody">
		              			<el-col :span="1" class="account_th">序号</el-col>
		              			<el-col :span="5" class="account_th">应收账款编号</el-col>
		              			<el-col :span="4" class="account_th">订单日期</el-col>
		              			<el-col :span="2" class="account_th">订单笔数</el-col>
		              	...
		              	<div v-for="(item,index) in financeDetailReceivables">
			              	<el-row  class="account_table_thead">
			              			<el-col :span="1" class="account_td">{{index+1}}</el-col>
			              			<el-col :span="5" class="account_td">{{item.receivableNo?item.receivableNo:'--'}}</el-col>
			              			<el-col :span="4" class="account_td">{{item.shipDate?item.shipDate:'--'}}</el-col>
			              			<el-col :span="2" class="account_td">{{item.orderNum?item.orderNum:'--'}}</el-col>
			              			...
			              			<el-col :span="4" class="account_td">{{item.returnDate?item.returnDate:'--'}}</el-col>
			              			<!--<el-col :span="2" class="account_td">
			              				<router-link :to="'/accountManage/accountDetail/' + item.receivableNo" style="cursor: pointer;color: rgb(64, 158, 255);">
				              				详情
			              				</router-link>
			              			</el-col>-->
			              	</el-row>
          ...
          <el-tab-pane v-if="false" label="融资评分" name="second">
            <div class="tab-content">
	            	...
	            	<el-col :span="5">
	            		<div style="border: 1px solid #bbb;padding: 15px 10px;width: 100%;background-color: #F8F8F8;">
		            		...
		            		<div class="suc" style="text-align: center;margin-top: 18px;">
		            			<div  style="font-size: 36px;line-height: 40px;">80</div>
		            			<div>(建议通过)</div>
		            		</div>
		            	</div>
	            	</el-col>
          ...
          <el-tab-pane label="放款登记" name="second">
            <div class="tab-content">
                ...
                <div class="info-list" style="text-align: right;">
                  <el-button v-if="!roleHasPermissions['loan_manage_loan_list_add']" @click="resetBankserial('loan')" :disabled="!(headStatus === 'WAIT_LOAN')">重置</el-button>
...
//      this.getComboboxBankList();
      ...
      getFinanceDetail (){
          ...
          if (res.data.code === '200') {
	      		...
	      		this.backPlanList = res.data.data.backPlanList;
          } else {
