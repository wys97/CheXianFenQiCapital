  ...
  <div class="page-container" ref="page-container" id="page-container"><!---权限管理-用户维护--->
    <div class="filter-container" ref="filter-container" id="filter-container">
      <el-form :inline="true" ref="listQueryForm" :model="listQuery">
        ...
        <el-form-item>
          <el-button  v-if="roleHasPermissions['permission_manage_operator_manage_list']" @click="referList" size="mini" type="primary" icon="el-icon-search">查询</el-button>
          <el-button  @click="resetForm('listQueryForm')" size="mini"  icon="el-icon-refresh">重置</el-button>
          <el-button  v-if="roleHasPermissions['permission_manage_operator_manage_add']" @click="dialogFormVisibleAddUser = true" size="mini" type="primary" icon="el-icon-plus">新增</el-button>
        </el-form-item>
      </el-form>
    </div>
