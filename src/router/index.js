...
//      roleName: 'payment_manage_payment_list_menu',
        name: '商户进件审核列表',
        component: resolve => require(['@/page/merchantAuditManage/merchantAuditList.vue'], resolve)
      },
      {
        hidden: true,
        path: 'merchantAuditDetail/:id',
        roleName: 'payment_manage_payment_list_view',
        name: '商户进件审核详情',
        component: resolve => require(['@/page/merchantAuditManage/merchantAuditDetail.vue'], resolve)
      },
      {
        hidden: true,
        path: 'chinaTravelBankDetail/:id',
        roleName: '', // merchantAuditManage/chinaTravelBankDetail
        name: '授信报告详情',
        component: resolve => require(['@/page/merchantAuditManage/chinaTravelBankDetail.vue'], resolve)
      }
    ]
  },
  {
