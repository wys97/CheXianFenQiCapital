...
export function detail (financeNo) {
  ...
  return fetch({
    url: test + '/capital-api/loan/detail',
    method: 'post',
    data
  })
}
...
export function uploadBankserial (data) {
  return fetch({
    url: test + '/capital-api/loan/upload_bankserial',
    method: 'post',
    isFormData: true,
...
export function saveBankserial ({financeNo,bankSerials,marginFlow}) {
  ...
  return fetch({
    url: test + '/capital-api/loan/save_bankserial',
    method: 'post',
    data
  })
}
...
export function viewBankserial (financeNo) {
  ...
  return fetch({
    url: test + '/capital-api/loan/view_bankserial',
    method: 'post',
    data
  })
}
...
export function confirmPass (financeNo) {
  ...
  return fetch({
    url: test + '/capital-api/loan/confirm',
    method: 'post',
    data
  })
}
...
export function refuse ({financeNo,reason}) {
  ...
  return fetch({
    url: test + '/capital-api/loan/refuse',
    method: 'post',
    data
  })
}
...
export function capticalSign ({financeNo}) {
  ...
  return fetch({
    url: test + '/capital-api/loan/captical_sign',
    method: 'post',
    data
  })
}
