...
export function checkHead (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalsecond/finalsecond_head',
    method: 'post',
    data
  })
}
...
export function queryController (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalsecond/query_controller',
    method: 'post',
    data
  })
}
...
export function repreInfo (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalsecond/repre_info',
    method: 'post',
    data
  })
}
...
export function verifyEnterpriseSale (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalsecond/verify_enterprise_sale',
    method: 'post',
    data
  })
}
...
export function invoiceBankSale (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalsecond/invoice_bank_sale',
    method: 'post',
    data
  })
}
...
export function verifyBusinessOperatCapital (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalsecond/verify_business_operat_capital',
    method: 'post',
    data
  })
}
...
export function enterpriseDebt (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalsecond/enterprise_debt',
    method: 'post',
    data
  })
}
...
export function enterpriseFinance (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalsecond/enterprise_finance',
    method: 'post',
    data
  })
}
...
export function spotCheck (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalsecond/spot_check',
    method: 'post',
    data
  })
}
...
export function verifyNegativeInfo (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalsecond/verify_negative_info',
    method: 'post',
    data
  })
}
...
export function signConclusion (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalsecond/check_detail',
    method: 'post',
    data
  })
}
...
export function scorecardQuery(supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalsecond/scorecard/query',
    method: 'post',
    data
  })
}
...
export function checkPass(supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalsecond/finalsecond_pass',
    method: 'post',
    data
  })
}
...
export function checkReject({supplierId,remark}) {
  ...
  return fetch({
    url: test + '/admin/finalsecond/finalsecond_reject',
    method: 'post',
    data
  })
}
...
export function recheckDetail(supplierId) {
  ...
  return fetch({
    url: test + '/admin/review/recheck_detail',
    method: 'post',
    data
  })
}
 ...
 * @param supplierId 商户ID
 */
export function reviewDetail(supplierId) {
	let data = {
		supplierId
	}
  return fetch({
    url: test + '/admin/finalfirst/finalfirst_detail',
    method: 'post',
    data
  })
}
 ...
 * @param supplierId 商户ID
 */
export function reviewSave({supplierId,remark}) {
	let data = {
		supplierId,
		remark
	}
  return fetch({
    url: test + '/admin/finalfirst/finalfirst_save',
    method: 'post',
    data
  })
}
 ...
 * @param supplierId 商户ID
 */
export function finalsecondDetail(supplierId) {
	let data = {
		supplierId
	}
  return fetch({
    url: test + '/admin/finalsecond/finalsecond_detail',
    method: 'post',
    data
  })
}
 ...
 * @param supplierId 商户ID
 */
export function finalsecondSave({supplierId,remark}) {
	let data = {
		supplierId,
		remark
	}
  return fetch({
    url: test + '/admin/finalsecond/finalsecond_save',
    method: 'post',
    data
  })
}
