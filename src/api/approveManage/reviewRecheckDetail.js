...
export function queryController (supplierId) {
  ...
  return fetch({
    url: test + '/admin/review/query_controller',
    method: 'post',
    data
  })
}
...
export function repreInfo (supplierId) {
  ...
  return fetch({
    url: test + '/admin/review/repre_info',
    method: 'post',
    data
  })
}
...
export function verifyEnterpriseSale (supplierId) {
  ...
  return fetch({
    url: test + '/admin/review/verify_enterprise_sale',
    method: 'post',
    data
  })
}
...
export function invoiceBankSale (supplierId) {
  ...
  return fetch({
    url: test + '/admin/review/invoice_bank_sale',
    method: 'post',
    data
  })
}
...
export function verifyBusinessOperatCapital (supplierId) {
  ...
  return fetch({
    url: test + '/admin/review/verify_business_operat_capital',
    method: 'post',
    data
  })
}
...
export function enterpriseDebt (supplierId) {
  ...
  return fetch({
    url: test + '/admin/review/enterprise_debt',
    method: 'post',
    data
  })
}
...
export function enterpriseFinance (supplierId) {
  ...
  return fetch({
    url: test + '/admin/review/enterprise_finance',
    method: 'post',
    data
  })
}
...
export function spotCheck (supplierId) {
  ...
  return fetch({
    url: test + '/admin/review/spot_check',
    method: 'post',
    data
  })
}
...
export function verifyNegativeInfo (supplierId) {
  ...
  return fetch({
    url: test + '/admin/review/verify_negative_info',
    method: 'post',
    data
  })
}
...
export function signConclusion (supplierId) {
  ...
  return fetch({
    url: test + '/admin/review/check_detail',
    method: 'post',
    data
  })
}
...
export function scorecardQuery(supplierId) {
  ...
  return fetch({
    url: test + '/admin/review/scorecard/query',
    method: 'post',
    data
  })
}
 ...
 * @param supplierId 商户ID
 */
export function checkPass({supplierId,remark}) {
  const data = {
    supplierId,
    remark
  }
  return fetch({
    url: test + '/admin/review/reject',
    method: 'post',
    data
  })
}
...
export function checkReject({supplierId,remark}) {
  ...
  return fetch({
    url: test + '/admin/review/repulse_reject',
    method: 'post',
    data
  })
}
