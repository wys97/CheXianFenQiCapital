...
export function checkHead (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalfirst/finalfirst_head',
    method: 'post',
    data
  })
}
...
export function queryController (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalfirst/query_controller',
    method: 'post',
    data
  })
}
...
export function repreInfo (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalfirst/repre_info',
    method: 'post',
    data
  })
}
...
export function verifyEnterpriseSale (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalfirst/verify_enterprise_sale',
    method: 'post',
    data
  })
}
...
export function invoiceBankSale (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalfirst/invoice_bank_sale',
    method: 'post',
    data
  })
}
...
export function verifyBusinessOperatCapital (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalfirst/verify_business_operat_capital',
    method: 'post',
    data
  })
}
...
export function enterpriseDebt (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalfirst/enterprise_debt',
    method: 'post',
    data
  })
}
...
export function enterpriseFinance (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalfirst/enterprise_finance',
    method: 'post',
    data
  })
}
...
export function spotCheck (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalfirst/spot_check',
    method: 'post',
    data
  })
}
...
export function verifyNegativeInfo (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalfirst/verify_negative_info',
    method: 'post',
    data
  })
}
...
export function signConclusion (supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalfirst/check_detail',
    method: 'post',
    data
  })
}
...
export function scorecardQuery(supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalfirst/scorecard/query',
    method: 'post',
    data
  })
}
...
export function checkPass(supplierId) {
  ...
  return fetch({
    url: test + '/admin/finalfirst/finalfirst_pass',
    method: 'post',
    data
  })
}
...
export function checkReject({supplierId,remark}) {
  ...
  return fetch({
    url: test + '/admin/finalfirst/finalfirst_reject',
    method: 'post',
    data
  })
}
