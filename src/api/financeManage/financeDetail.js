...
export function riskResult (financeNo) {
  ...
  return fetch({
    url: test + '/capital-api/finance/risk_result',
    method: 'post',
    data
  })
}
...
export function bankSerialMatch (financeNo) {
  ...
  return fetch({
    url: test + '/capital-api/finance/bank_serial_match',
    method: 'post',
    data
  })
}
...
export function financeAuditPass (financeNo) {
  ...
  return fetch({
    url: test + '/capital-api/finance/audit_pass',
    method: 'post',
    data
  })
}
...
export function financeAuditRefuse ({financeNo,reason}) {
  ...
  return fetch({
    url: test + '/capital-api/finance/audit_refuse',
    method: 'post',
    data
  })
}
