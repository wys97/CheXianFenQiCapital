...
export function getListData ({page, limit,roleName}) {
  ...
  return fetch({
    url: test + '/capital-api/role/list',
    method: 'post',
    data
  })
}
...
export function updateRole ({id,roleName,remark}) {
  ...
  return fetch({
    url: test + '/capital-api/role/update',
    method: 'post',
    data
  })
}
...
export function deleteRole ({id}) {
  ...
  return fetch({
    url: test + '/capital-api/role/delete',
    method: 'post',
    data
  })
}
...
export function getPermissionList ({id}) {
  ...
  return fetch({
    url: test + '/capital-api/role/permission_list',
    method: 'post',
    data
  })
}
...
export function grantPermission ({id,permissionCodes}) {
  ...
  return fetch({
    url: test + '/capital-api/role/grant_permission',
    method: 'post',
    data
  })
}
