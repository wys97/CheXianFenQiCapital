...
export function checkHead (supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/head',
    method: 'post',
    data
  })
}
...
export function getCompBasicInfo (supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/basic_info',
    method: 'post',
    data
  })
}
...
export function checkboxLoad () {
  return fetch({
    url: test + '/capital-api/creditline_report_zl/credit_property_role',
    method: 'post'
  })
}
...
export function queryCreditHistory () {
  return fetch({
    url: test + '/capital-api/creditline_report_zl/proposer_credit_history',
    method: 'post'
  })
}
...
export function queryController (supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/credit_property',
    method: 'post',
    data
  })
}
...
export function saveController ({supplierCapitalId,creditPropertyTime,creditPropertyPlace,creditPropertyRole}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/credit_property_save',
    method: 'post',
    data
  })
}
...
export function queryApplier(supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/proposer_basic',
    method: 'post',
    data
  })
}
...
export function editApplier({supplierCapitalId,proposerEnterpriseName,proposerTrade,proposerGrade,proposerRegisterAddress,proposerWorkAddress,proposerRepreName,proposerControllerName,proposerBank,proposerBusinessScope}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/proposer_basic_save',
    method: 'post',
    data
  })
}
...
export function queryApplierCount (supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/proposer_shareholding',
    method: 'post',
    data
  })
}
...
export function editApplierCount({supplierCapitalId,proposerRegisterCapital,proposerActualCapital,shareHolding}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/proposer_shareholding_save',
    method: 'post',
    data
  })
}
...
export function queryCompany (supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/proposer_relateenterprise',
    method: 'post',
    data
  })
}
...
export function editCompany({supplierCapitalId,relateEnterprise}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/proposer_relateenterprise_save',
    method: 'post',
    data
  })
}
...
export function queryMuchInfo (supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/proposer_muchinfo',
    method: 'post',
    data
  })
}
...
export function editMuchInfo({supplierCapitalId, proposerOperatorQuality, proposerCreditHistory, proposerEnterpriseBadReason,proposerControllerBadReason, proposerDevelopHistory, proposerManageStructure}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/proposer_muchinfo_save',
    method: 'post',
    data
  })
}
...
export function queryAsset(supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/propose_asset',
    method: 'post',
    data
  })
}
...
export function editAsset({supplierCapitalId,asset}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/proposer_asset_save',
    method: 'post',
    data
  })
}
...
export function queryCreditVariety (supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/apply_credit_variety',
    method: 'post',
    data
  })
}
...
export function editCredit({supplierCapitalId, applyCreditVariety}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/apply_credit_variety_save',
    method: 'post',
    data
  })
}
...
export function queryCreditInfo (supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/apply_credit_now',
    method: 'post',
    data
  })
}
...
export function editCreditInfo({supplierCapitalId, applyCreditNow}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/apply_credit_now_save',
    method: 'post',
    data
  })
}
...
export function querySameTrade(supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/sametrade_info',
    method: 'post',
    data
  })
}
...
export function saveSameTrade({supplierCapitalId, sametradeInfo}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/sametrade_info_save',
    method: 'post',
    data
  })
}
...
export function queryGuarantee(supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/sametrade_guarantee',
    method: 'post',
    data
  })
}
...
export function saveGuarantee({supplierCapitalId, sametradeGuaranteeStatus, sametradeGuarantee, sametradeGuaranteeExplain}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/sametrade_guarantee_save',
    method: 'post',
    data
  })
}
...
export function financeCheckList () {
  return fetch({
    url: test + '/capital-api/creditline_report_zl/sametrade_society_finance',
    method: 'post'
  })
}
...
export function queryOverallMerit(supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/sametrade_overall_merit',
    method: 'post',
    data
  })
}
...
export function saveOverallMerit({supplierCapitalId, sametradeSocietyFinance, sametradeOverallMerit, sametradeSocietyFinanceRemark, sametradeResearchConclusions}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/sametrade_overall_merit_save',
    method: 'post',
    data
  })
}
...
export function queryBorrowInfo(supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/borrow_info',
    method: 'post',
    data
  })
}
...
export function saveBorrowInfo({supplierCapitalId, borrowUse, borrowGuaranteeMeasure, borrowRepaySource}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/borrow_info_save',
    method: 'post',
    data
  })
}
...
export function queryProduceInfo(supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/produce_self_third',
    method: 'post',
    data
  })
}
...
export function saveProduceInfo({supplierCapitalId, produceSelf, produceThird, produceThirdDescribe}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/produce_self_third_save',
    method: 'post',
    data
  })
}
...
export function invoiceCheckRadio () {
  return fetch({
    url: test + '/capital-api/combobox/invoice_check_type',
    method: 'post'
  })
}
...
export function queryInvoiceBank(supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/produce_invoice_bank',
    method: 'post',
    data
  })
}
...
export function saveInvoiceBank({supplierCapitalId, produceInvoiceCheckType, produceInvoiceStat, produceBankStat, produceVerify, produceInvoiceStatDescribe, produceBankStatDescribe}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/produce_invlice_bank_save',
    method: 'post',
    data
  })
}
...
export function bankCheckList () {
  return fetch({
    url: test + '/capital-api/combobox/bank_stat_type',
    method: 'post'
  })
}
...
export function querySupplier(supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/produce_major_people',
    method: 'post',
    data
  })
}
...
export function saveSupplier({supplierCapitalId, produceMajorSupplier, produceMajorSeller}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/produce_major_people_save',
    method: 'post',
    data
  })
}
...
export function checkMethodList () {
  return fetch({
    url: test + '/capital-api/creditline_report_zl/produce_verify_method',
    method: 'post'
  })
}
...
export function checkMaterialList () {
  return fetch({
    url: test + '/capital-api/creditline_report_zl/produce_verify_material',
    method: 'post'
  })
}
...
export function queryProduceOther(supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/produce_other',
    method: 'post',
    data
  })
}
...
export function saveProduceOther({supplierCapitalId, produceEvaluate, produceCooperationDescription, produceVerifyMethod, produceVerifyMaterial, produceBriefDescription, produceResearchConclusion, produceVerifyMethodRemark, produceVerifyMaterialRemark}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/produce_other_save',
    method: 'post',
    data
  })
}
...
export function queryFinanceAnalysis(supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/finance_analysis',
    method: 'post',
    data
  })
}
...
export function saveFinanceAnalysis({supplierCapitalId, financeDebt, financeLossIncome, financeSubjectAnalysis}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/finance_analysis_save',
    method: 'post',
    data
  })
}
...
export function querySpotCheck(supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/spot_check_picture',
    method: 'post',
    data
  })
}
...
export function saveSpotCheck({supplierCapitalId, spotCheck}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/spot_check_picture_save',
    method: 'post',
    data
  })
}
...
export function queryNegativeInfo(supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/negative_info',
    method: 'post',
    data
  })
}
...
export function saveNegativeInfo({supplierCapitalId, negativeInfo}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/negative_info_save',
    method: 'post',
    data
  })
}
...
export function queryOtherInfo(supplierCapitalId) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/approval_opinion',
    method: 'post',
    data
  })
}
...
export function saveLimitCal({supplierCapitalId, limitCal}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/limit_calculation_str_save',
    method: 'post',
    data
  })
}
...
export function saveGuaranteeAnalysis({supplierCapitalId, guaranteeAnalysis}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/guarantee_analysis_str_save',
    method: 'post',
    data
  })
}
...
export function saveRiskPoint({supplierCapitalId, riskPoint}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/risk_point_str_save',
    method: 'post',
    data
  })
}
...
export function saveOtherQuestion({supplierCapitalId, otherQuestion}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/other_question_str_save',
    method: 'post',
    data
  })
}
...
export function saveCreditlineConclusion({supplierCapitalId, creditlineConclusion}) {
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/creditline_conclusion_str_save',
    method: 'post',
    data
  })
}
...
export function saveApprovalOpinion({
  ...
  return fetch({
    url: test + '/capital-api/creditline_report_zl/approval_opinion_str_save',
    method: 'post',
    data
  })
}
