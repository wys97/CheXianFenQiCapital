...
export function queryContractTop (id) {
  ...
  return fetch({
    url: test + '/capital-api/agreement/query_contract_top',
    method: 'post',
    data
  })
}
...
export function queryContract (id) {
  ...
  return fetch({
    url: test + '/capital-api/agreement/query_contract',
    method: 'post',
    data
  })
}
...
export function saveContract ({supplierId,capitalId,signStep,agreementType,agreementNo,agreementName,files,remark}) {
  ...
  return fetch({
    url: test + '/capital-api/agreement/save_contract',
    method: 'post',
    data
  })
}
...
export function updateContract ({id,signStep,agreementType,agreementNo,agreementName,files,remark}) {
  ...
  return fetch({
    url: test + '/capital-api/agreement/update_contract',
    method: 'post',
    data
  })
}
...
export function deleteContract (id) {
  ...
  return fetch({
    url: test + '/capital-api/agreement/delete_contract',
    method: 'post',
    data
  })
}
...
export function signStep () {
  return fetch({
    url: test + '/capital-api//agreement/sign_step',
    method: 'post'
  })
}
/**
