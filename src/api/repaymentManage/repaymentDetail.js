...
export function RegisterDetail (orderNo) {
  ...
  return fetch({
    url: test + '/capital-api/supplier/register_detail',
    method: 'post',
    data
  })
}
...
export function repaymentUpdateStatus ({orderNo,status}) {
  ...
  return fetch({
    url: test + '/capital-api/supplier/register_detail_update_status',
    method: 'post',
    data
  })
}
...
export function incomeNewIncome () {
  return fetch({
    url: test + '/capital-api/supplier/bankIncome_new_income',
    method: 'post'
  })	
}
...
export function uploadBankserial (data) {
  return fetch({
    url: test + '/capital-api/supplier/bankIncome_upload_bankserial',
    method: 'post',
    isFormData: true,
...
export function incomeSave ({supplierId,bankName,bankAccountNo,incomeDate,bankSerialNo,bankAmt,bankKey}) {
  ...
  return fetch({
    url: test + '/capital-api/supplier/bankIncome_new_income_save',
    method: 'post',
    data
  })
}
...
export function incomeDetail (orderNo) {
  ...
  return fetch({
    url: test + '/capital-api/supplier/bankIncome_detail',
    method: 'post',
    data
  })
}
...
export function incomeRefuse ({orderNo,remark}) {
  ...
  return fetch({
    url: test + '/capital-api/supplier/bankIncome_detail_refuse',
    method: 'post',
    data
  })
}
...
export function incomePass (orderNo) {
  ...
  return fetch({
    url: test + '/capital-api/supplier/bankIncome_detail_pass',
    method: 'post',
    data
  })
}
 ...
 * @param orderNo 登记单号
 */
export function repaymentDetail (backPlanNo) {
  const data = {
    backPlanNo
  }
  return fetch({
    url: test + '/capital-api/supplier/repayment_detail',
    method: 'post',
    data
  })
}
